...
class MainActivityTest {
    ...
    @Test fun bottom_navigation_view_and_elements_is_displayed() {
        ...
        onView(withId(R.id.watchlist_fragment_dest)).check(matches(isDisplayed()))
        onView(withId(R.id.discover_fragment_dest)).check(matches(isDisplayed()))
        onView(withId(R.id.search_fragment_dest)).check(matches(isDisplayed()))
        onView(withId(R.id.sv_search)).check(matches(isDisplayed()))

        // status
        onView(withId(R.id.watchlist_fragment_dest)).check(matches(isSelected()))
        onView(withId(R.id.discover_fragment_dest)).check(matches(not(isSelected())))
        onView(withId(R.id.search_fragment_dest)).check(matches(not(isSelected())))
    }

    @Test fun navigate_to_each_bottom_nav_option() {
        // home
        onView(withId(R.id.discover_fragment_dest)).perform(click())
        onView(withId(R.id.discover_fragment_dest)).check(matches(isSelected()))
        // progress
        onView(withId(R.id.watchlist_fragment_dest)).perform(click())
        onView(withId(R.id.watchlist_fragment_dest)).check(matches(isSelected()))
        // search
