...
import com.sunrisekcdeveloper.showtracker.features.watchlist.application.LoadCompletedMediaUseCaseContract
import com.sunrisekcdeveloper.showtracker.features.watchlist.domain.repository.WatchListRepositoryContract

class LoadCompletedMediaUseCase(
    @WatchlistRepo private val watchListRepo: WatchListRepositoryContract
) : LoadCompletedMediaUseCaseContract {
    override suspend fun invoke(): Resource<List<CompletedMediaEntity>> =
        watchListRepo.completedMedia()
}