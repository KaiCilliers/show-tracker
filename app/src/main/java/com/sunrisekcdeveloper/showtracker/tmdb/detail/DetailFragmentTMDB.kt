...
package com.sunrisekcdeveloper.showtracker.tmdb.detail
...
import com.sunrisekcdeveloper.showtracker.databinding.FragmentMovieDetailTmdbBinding

class DetailFragmentTMDB : Fragment() {

    private lateinit var binding: FragmentMovieDetailTmdbBinding

    private val arguments: DetailFragmentTMDBArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        binding = FragmentMovieDetailTmdbBinding.inflate(inflater)
        setup()
        bind()
        return binding.root
    }
