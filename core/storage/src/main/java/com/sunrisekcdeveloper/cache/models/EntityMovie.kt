...
package com.sunrisekcdeveloper.cache.models
...
data class EntityMovie (
    ...
    @ColumnInfo(name = "movie_backdrop_path") val backdropPath: String,
    @ColumnInfo(name = "movie_rating") val rating: Float,
    @ColumnInfo(name = "movie_popularity") val popularityValue: Float,
