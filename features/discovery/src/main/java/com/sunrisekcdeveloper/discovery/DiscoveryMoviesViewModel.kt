...
import com.sunrisekcdeveloper.discovery.usecase.LoadPopularMoviesUseCaseContract
import com.sunrisekcdeveloper.discovery.usecase.LoadTopRatedMoviesUseCaseContract
import com.sunrisekcdeveloper.discovery.usecase.LoadUpcomingMoviesUseCaseContract
...
@HiltViewModel
class DiscoveryMoviesViewModel @Inject constructor(
