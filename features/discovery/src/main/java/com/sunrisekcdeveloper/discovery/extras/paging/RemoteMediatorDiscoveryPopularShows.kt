...
class RemoteMediatorDiscoveryPopularShows(
...
//                    throw InvalidObjectException("Remote key should not be null for $loadType")
        ...
        return when (val response = remote.popularShows(page!!)) {
            is NetworkResult.Success -> {
                ...
                val uiModels =
                    response.data.media.map { it.asUIModelDiscovery(ListType.ShowPopular) }
                ...
                try {
                    ...
                    database.withTransaction {
                        ...
                        if (loadType == LoadType.REFRESH) {
                            ...
                            database.discoveryDao().clearList(ListType.ShowPopular)
                        }
