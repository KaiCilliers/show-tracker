...
import com.sunrisekcdeveloper.discovery.usecase.LoadAiringTodayShowsUseCaseContract
import com.sunrisekcdeveloper.discovery.usecase.LoadPopularShowsUseCaseContract
import com.sunrisekcdeveloper.discovery.usecase.LoadTopRatedShowsUseCaseContract
...
@HiltViewModel
class DiscoveryShowsViewModel @Inject constructor(
