...
class RemoteMediatorDiscoveryUpcomingMovies(
...
//                    throw InvalidObjectException("Remote key should not be null for $loadType")
        ...
        return when (val response = remote.upcomingMovies(page!!)) {
            is NetworkResult.Success -> {
                ...
                val uiModels =
                    response.data.media.map { it.asUIModelDiscovery(ListType.MovieUpcoming) }
                ...
                try {
                    ...
                    database.withTransaction {
                        ...
                        if (loadType == LoadType.REFRESH) {
                            ...
                            database.discoveryDao().clearList(ListType.MovieUpcoming)
                        }
