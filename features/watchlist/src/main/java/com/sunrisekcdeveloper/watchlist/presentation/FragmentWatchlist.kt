...
import com.sunrisekcdeveloper.watchlist.domain.model.*
import com.sunrisekcdeveloper.watchlist.other.*
...
class FragmentWatchlist : Fragment() {
    ...
    private var allMovies: List<UIModelWatchlistMovie> = listOf()
...
//                    )
    ...
    private fun renderSuccess(
        movies: List<UIModelWatchlistMovie>,
